...
public class Gladiator {
    ...
    public Trigger b_POV1Up() {return controller.button(6);}
    public Trigger b_POV1Right() {return controller.button(7);}
    public Trigger b_POV1Down() {return controller.button(8);}
    public Trigger b_POV1Left() {return controller.button(9);}
    public Trigger b_POV1Pushed() {return controller.button(10);}
    public Trigger b_POV2Up() {return controller.button(11);}
    public Trigger b_POV2Right() {return controller.button(12);}
    public Trigger b_POV2Down() {return controller.button(13);}
    public Trigger b_POV2Left() {return controller.button(14);}
    public Trigger b_POV2Pushed() {return controller.button(15);}
    public Trigger b_POV3Up() {return controller.button(16);}
    public Trigger b_POV3Right() {return controller.button(17);}
    public Trigger b_POV3Down() {return controller.button(18);}
    public Trigger b_POV3Left() {return controller.button(19);}
    public Trigger b_POV3Pushed() {return controller.button(20);}
